# Contributing to Loan Default Prediction
...
2. **Clone** your fork: `git clone https://github.com/<your-username>/loan-default-prediction.git`
...
Credit risk model with SHAP explainability and Streamlit risk calculator.
